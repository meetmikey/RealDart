module.exports = 
  ...
  IMPORT_CONTACT_IMAGES_CONTACT_BATCH_SIZE: 200
  IMPORT_CONTACT_IMAGES_ASYNC_LIMIT: 20
  ...
  sqs:
    ...
    DEFAULT_WORKER_TIMEOUT: 1000 * 60 * 10 #10 minutes
  ...
  lock:
    BASE_WAIT_TIME_MS: 100
    MAX_WAIT_TIME_MS: 1000 * 60 * 5 # 5 minutes
    EXPIRE_TIME_SECONDS: 60 * 20 # 20 minutes
    keyPrefix:
      contacts: 'contacts-'
